...
a: boolean = false;
  constructor(private _http:LabAdminService,private modalService: NgbModal,private fb:FormBuilder,private toastr: ToastrService) {
...
console.log( "hi" + this.Measures[0].measureName)
 ...
 getReport(data)
  {
    this._http.getReports(data.reg_id,data.serviceName)
    .subscribe(
    data => {
