...
export class RegistrationComponent implements OnInit {
  ...
  value: any
  constructor(private router: Router, private fb: FormBuilder, private _http: RegisterService, private modalService: NgbModal, private toastr: ToastrService) {
  ...
  open(basic) {
    ...
    this.popHandler[nodeName] = this.modalService.open(basic, { ariaLabelledBy: 'modal-basic-title' });
