...
export class PatientlistService {
  ...
  // 104.211.229.17:8084/v1/getDetailedReport/{regId}
  // 104.211.229.17:8084/v1/getDetailedAdvanceReport/{regId}
  ...
  getInpatient(count):Observable<any> {
    return this._http.get('http://104.211.229.17:8084/v1/patient/patientDetails/'+count);
  ...
  postCreate(regId,param):Observable<any>{
    ...
    return this._http.post('http://104.211.229.17:8084/v1/patient/advanceAmount/'+regId, param, );
...
post(parm):Observable<any>{
  ...
  return this._http.post('http://104.211.229.17:8084/v1/patient/extend', parm, );
...
getType(dischargeType): Observable<any> {
  return this._http.get('http://104.211.229.17:8084/v1/patient/discharge/'+dischargeType);
}
...
{
  return this._http.get('http://104.211.229.17:8084/v1/getDetailedReport/'+regid) 
}
}
