...
export class UserExistComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private fb1:FormBuilder, private _http: UserExistService, private router: Router, private modalService: NgbModal,private toastr: ToastrService) {
