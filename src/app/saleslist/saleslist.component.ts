...
export class SaleslistComponent implements OnInit {
  ...
  a: boolean = false;
  constructor(private _http: SaleslistService, private toastr: ToastrService, private modalService: NgbModal) { }
  Edit: MDetails[] = []
  ngOnInit() {
    this.showAll();
  ...
  setMedicineDetails(data) {
    ...
    this._http.getMedicineDetails(data.batchNo, data.medicineName)
      .subscribe(
      response => {
  ...
  batches = []
  setBatches(data) {
    this._http.getBatch(data.medicineName)
      .subscribe(
      response => {
