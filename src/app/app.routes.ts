...
export const appRoutes = [
    ...
    { path: 'itemledgerreport', component: ItemledgerreportComponent, canActivate: [AuthGuard] },
    // { path: 'register', component: RegistrationComponent, canActivate: [AuthGuard] },
    {
        path: "register",
        loadChildren:
        "../app/registration/registration.module#RegistrationModule",
        canActivate: [AuthGuard]
    },
    {
        path: "existing",
        loadChildren:
        "../app/existing/existing.module#ExistingModule",
        canActivate: [AuthGuard]
    },
    // {
    //     path: "existvendor",
...

    {
        path: "vendor",
        loadChildren:
        "../app/vendor/vendor.module#VendorModule",
        canActivate: [AuthGuard]
    },
    {
        path: "wardonline",
        loadChildren:
        "../app/wardonline/wardonline.module#WardonlineModule",
        canActivate: [AuthGuard]
    },
    ...
    { path: 'ipphlist', component: PharmacylistComponent, canActivate: [AuthGuard] },
    ...
    {
        path: 'olist', component: OtherPatientsComponent, canActivate: [AuthGuard]
    },
    {
    ...
    {
        path: 'op-ip', component:  OpIpEditComponent, canActivate: [AuthGuard]
    },
    ...
    {
        path: 'pvlist', component: PaymentvoucherComponent, canActivate: [AuthGuard]
    },

    {
        path: 'bl', component: BedallocationComponent, canActivate: [AuthGuard]
    },
    {
    ...
    {
        path: 'slist', component: SaleslistComponent, canActivate: [AuthGuard]
    ...
    {
        path: 'inventorystatus', component: InventoryreportsComponent, canActivate: [AuthGuard]
    },

    {
        path: 'paymentvocher', component: PaymentvocherComponent, canActivate: [AuthGuard]
    },
    { path: 'otherreports', component: OtherreportsComponent, canActivate: [AuthGuard] },
    { path: 'referraldr', component: ReferraldrComponent, canActivate: [AuthGuard] },

    { path: 'referraldrlist', component: ReferraldrlistComponent, canActivate: [AuthGuard] },
    {
        path: 'doctor', component: DoctorComponent, canActivate: [AuthGuard]
    },
    {
        path: 'ospbillinglist', component: OspbillinglistComponent, canActivate: [AuthGuard]
    },

    {
        path: 'monthlyprogress', component:MonthlyprogressComponent, canActivate: [AuthGuard]
    },
