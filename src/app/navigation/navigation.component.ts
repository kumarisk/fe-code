    ...
    constructor(private router: Router, private authenticationService: AuthenticationService) { 
        ...
        this.menuPages = { 
            ...
            "ADMIN":[
                ...
                {link:'./wardonline', name:'Ward Online Issues',icon:'fa fa-users fa-lg'},
                ...
                {link:'./appointment', name:'Appointment',icon:'fa fa-user-md fa-lg'},
                {link:'./appointmentlist', name:'Appointment List',icon:'fa fa-user-md fa-lg'},
                {link:'./paymentvocher', name:'Payment Voucher',icon:'fa fa-money fa-lg'},
                {link:'./pvlist', name:'Payment Voucher List',icon:'fa fa-money fa-lg'},
                
                {link:'./register', name: 'Patient Registration',icon:'fa fa-users fa-lg'},
                {link:'./existing', name: 'Existing Patients', icon:'fa fa-user fa-lg'},
                {link:'./patientlist', name: 'Inpatient List', icon:'fa fa-users fa-lg'},
                {link:'./op', name: 'Outpatient List', icon:'fa fa-users fa-lg'},
                {link:'./olist', name: 'Other patient List', icon:'fa fa-users fa-lg'},
                
          
                {link:'./user', name: 'User Registration', icon:'fa fa-plus-square fa-lg'},
                ...
                {link:'./proclist', name: 'GRN List', icon:'fa fa-shopping-cart fa-lg'},
                ...
                {link:'./slist', name: 'Sale Management list', icon:'fa fa-line-chart fa-lg'},
                {link:'./return', name: 'Return Management', icon:'fa fa-retweet fa-lg'},
                {link:'./refund', name: 'Return List', icon:'fa fa-repeat fa-lg'},
                {link:'./ipphlist', name: 'IP Pharmacy List', icon:'fa fa-line-chart fa-lg'},
                {link:'./nurse', name: 'Nurse', icon:'fa fa-stethoscope fa-lg'},
                  {link:'./doctor', name: 'Doctor', icon:'fa fa-user-md fa-lg'},

                {link: './admindoctorview', name: 'Doctor Statistics', icon:'fa fa-user-md fa-lg'},
                 {link: './monthlyprogress', name: 'MonthlyProgress ', icon:'fa fa-user-md fa-lg'},
                ...
                {link:'./osp', name: 'OSP Billing', icon:'fa fa-credit-card fa-lg'},
                 {link: './ospbillinglist', name: 'OSP Billing List', icon:'fa fa-user-md fa-lg'},
                {link:'./lab', name: 'OP/IP Billing', icon:'fa fa-flask fa-lg'},
                {
                    link: './op-ip', name:'OP/IP Cancellation',  icon:'fa fa-flask fa-lg'
                },
                ...
                {link:'./duebills', name: 'Due Bills', icon:'fa fa-credit-card fa-lg'},
                {link:'./bill', name: ' IP Final Billing', icon:'fa fa-credit-card fa-lg'},
                {link:'./report', name: 'Reports', icon:'fa fa-credit-card fa-lg'},
                {link:'./referraldr', name: 'Referral Dr', icon:'fa fa-credit-card fa-lg'},
                {link:'./referraldrlist', name: 'Referral Dr List', icon:'fa fa-credit-card fa-lg'},
                {link:'./inventorystatus', name: 'Inventory Reports', icon:'fa fa-credit-card fa-lg'},
                {link:'./itemledgerreport', name: 'Item Ledger Report', icon:'fa fa-credit-card fa-lg'},
            ],
        ...
        "FRONT OFFICE":[
            ...
            {link:'./existing', name: 'Existing Patients', icon:'fa fa-user fa-lg'},
            {link:'./op', name: 'Outpatient List', icon:'fa fa-users fa-lg'},
            {link:'./patientlist', name: 'Inpatientlist', icon:'fa fa-users fa-lg'},
            // {link:'./op', name: 'Outpatient List', icon:'fa fa-users fa-lg'},
            {link:'./lab', name: 'OP/IP Billing', icon:'fa fa-flask fa-lg'},
            {link:'./osp', name: 'OSP Billing', icon:'fa fa-credit-card fa-lg'},
            {link: './ospbillinglist', name: 'OSPBilling List', icon:'fa fa-user-md fa-lg'},
            {link:'./duebills', name: 'Due Bills', icon:'fa fa-credit-card fa-lg'},
            {link:'./bill', name: ' IP Final Billing', icon:'fa fa-credit-card fa-lg'},
            // {link:'./otherreports', name: 'OP Billing', icon:'fa fa-credit-card fa-lg'},
            {link:'./referraldr', name: 'Referral Dr', icon:'fa fa-credit-card fa-lg'},
